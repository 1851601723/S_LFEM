# -*- coding: utf-8 -*-
"""
Created on Fri Jun  4 21:12:56 2021
...
'''进行有限元前处理与单元、载荷等的初始化'''
from ini_2D_LEIL_L4_Buckling import *
...
'''进行迭代求解'''
KD = np.zeros([n_freedom,n_freedom])
KG = np.zeros([n_freedom,n_freedom])
