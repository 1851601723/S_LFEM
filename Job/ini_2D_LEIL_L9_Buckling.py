# -*- coding: utf-8 -*-
"""
Created on Sat Jun  5 15:26:44 2021

@author: XinLi
"""

from Material.Material_LE_Isotropy import material_LE_Isotropy
from Element.Element_2DS_LEIL_L9 import element_2DS_LEIL_L9
...
for i in range(n):
    for j in range(m):
        element.append(element_2DS_LEIL_L9([node[(2*i+0)*(2*m+1)+2*j+0],
...
for i in range(2*m+1):
    Other_constraints.append(constraint(node[-(i+1)].dof_num[0],'elastic boundary',[0,P/(2*m+1)],Loading))
