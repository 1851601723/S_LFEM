...
for i in range(numTimeStep2):
    dt.append(10.0/numTimeStep2)
    T.append(T0 + 10.0/numTimeStep2 * (i+1))
...
for i in range(numTimeStep2):
    ...
    gList.append(np.array([[0],[0],[0]]))
    fList.append(np.zeros([3,1]))
for i in range(int(numTimeStep2/4)):
    AMList.append([np.array([[i*4*0.0163/numTimeStep2],[0.0],[0.0]]),np.zeros([3,3])])
for i in range(int(numTimeStep2/2)):
    AMList.append([np.array([[0.0163-i*4*0.0163/numTimeStep2],[0.0],[0.0]]),np.zeros([3,3])])
for i in range(int(numTimeStep2/4)):
    AMList.append([np.array([[-0.0163+i*4*0.0163/numTimeStep2],[0.0],[0.0]]),np.zeros([3,3])])
...
FLoading1[-3] = 0.0
FLoading2.append('pass')
DLoading3.append(0.004018591649518487-0.00035)
