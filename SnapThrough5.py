...
AMList.append([np.array([[0.0043],[0.0],[0.0]]),np.zeros([3,3])])
for i in range(numTimeStep2):
    AMList.append([np.array([[0.0043+ i*0.012/numTimeStep2],[0.0],[0.0]]),np.zeros([3,3])])
    gList.append(np.array([[0],[0],[0]]))
    fList.append(np.zeros([3,1]))
...
FLoading1[-3] = 0.0
FLoading2.append('pass')
DLoading3.append(0.004001727343469367-0.00035)
